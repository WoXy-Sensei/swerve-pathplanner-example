...
//					+ ", next: " + nextTime);
	...
	public void reset(){
		write8(reg_t.BNO055_SYS_TRIGGER_ADDR, (byte)0x20 ); // (byte) 0x0B, (byte)0xB4, (byte)0x00]);
		setMode(opmode_t.OPERATION_MODE_IMUPLUS);
		//write8(reg_t.BNO055_SYS_TRIGGER_ADDR, (byte)0x0B );
		//write8(reg_t.BNO055_SYS_TRIGGER_ADDR, (byte)0xB4 );
